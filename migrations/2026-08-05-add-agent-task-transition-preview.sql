CREATE TABLE IF NOT EXISTS agent_task_transition_preview (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_agent_task_transition_preview_ref (preview_ref),
    KEY idx_agent_task_preview_owner_created (owner_user_id, created_at),
    KEY idx_agent_task_preview_session_status (agent_session_id, status),
    KEY idx_agent_task_preview_expires (expires_at)

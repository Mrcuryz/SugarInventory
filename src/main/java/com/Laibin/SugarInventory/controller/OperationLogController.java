...
public class OperationLogController {
    ...
    public Result<PageResult<OperationLogVO>> queryOperationLogs(
            @RequestBody OperationLogQueryDTO queryDTO) {
        return Result.success(ManagementViewAssembler.toOperationLogPage(
                operationLogService.queryOperationLogs(queryDTO)));
    }
}

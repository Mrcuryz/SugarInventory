...
CREATE TABLE `inventory`  (
  ...
  UNIQUE INDEX `uk_inventory_location`(`warehouse_id` ASC, `side` ASC, `row_number` ASC, `layer` ASC) USING BTREE,
...
CREATE TABLE `pallet_flow_record`  (
  ...
  INDEX `idx_flow_task_id`(`task_id` ASC) USING BTREE,
  ...
  INDEX `idx_flow_pallet_cycle_time`(`pallet_code_id` ASC, `cycle_no` ASC, `operation_time` ASC) USING BTREE,
  INDEX `idx_flow_operation_time`(`operation_time` ASC) USING BTREE,

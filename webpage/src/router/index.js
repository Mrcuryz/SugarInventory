...
const routes = [
  { path: '/login', name: 'Login', meta: { hiddenTab: true }, component: () => import('@/components/LoginModern.vue') },
  {
    ...
    children: [
      ...
      { path: 'production/daily-reports', name: 'ProductionDailyReport', meta: { title: '生产日报', keepAlive: true, permCode: 'production:daily-report:view' }, component: () => import('@/components/ProductionDailyReport.vue') },
      { path: 'equipment/assets', name: 'EquipmentAssets', meta: { title: '设备台账', keepAlive: true, permCode: 'equipment:asset:view' }, component: () => import('@/components/equipment/EquipmentAssets.vue') },
      { path: 'equipment/repairs', name: 'EquipmentRepairs', meta: { title: '修理记录', keepAlive: true, permCode: 'equipment:repair:view' }, component: () => import('@/components/equipment/EquipmentRepairs.vue') },
      { path: 'equipment/basic-data', name: 'EquipmentBasicData', meta: { title: '设备基础资料', keepAlive: true, permCode: 'equipment:config:view' }, component: () => import('@/components/equipment/EquipmentBasicData.vue') },

...
| `preview_task_transition` | Re-read selected pending finished-product inbound, outbound, or transfer tasks and create a short-lived, signed no-write preview. | `POST /api/logistics/agent-read/pallet-tasks/transition/preview` |
